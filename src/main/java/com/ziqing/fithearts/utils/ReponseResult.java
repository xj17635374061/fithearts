package com.ziqing.fithearts.utils;


/**
 * this class by created lixiaojie on 2018/6/5 13:50
 * 响应信息主体。返回给前端的数据（lixiaojie）
 **/
